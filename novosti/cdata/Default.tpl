...
<center><div style="width:620px; margin-bottom:30px;">
<div><font color="white"><strong>{title}</strong> {star-rate} </font></div>

<div style="text-align:justify; padding:3px; margin-top:3px; margin-bottom:5px; border-top:1px solid #00ff00;">{short-story}</div>

<div style="border-top:1px solid #00ff00; padding:3px;"><font color="white" size="2px";><em>Objavljeno: {date} Od: {author}</em></font></div>
</div></center>
HTML;
