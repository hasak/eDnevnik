...
// ---------------------------------------------------------------------------------------------------------------------
if((!isset($count_cute_news_includes) or !$count_cute_news_includes)
and $template != 'rss'){
///
/// Removing the "P0wered By..." line is NOT allowed by the CuteNews
License, only registered users are alowed to do so.
///
if(!file_exists(SERVDIR."cdata/data/reg.php")){ echo 'Your text here'; }
else{
include(SERVDIR."cdata/data/reg.php");
