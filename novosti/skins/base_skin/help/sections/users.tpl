...
Each user-level has limited permissions in doing specified actions and these permissions cannot be changed.<br>
...
<ol>
    ...
    <br>
    <li><b>Commenters</b> - when users from this level login, they are allowed only to change their passwords. Cannot post, edit news or perform any other action.
